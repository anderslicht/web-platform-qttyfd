window.addEventListener("keydown", (event) => { //tilføjer en eventlistener der registrerer tastatur tryk når vinduet er i fokus og sender data videre i event
  ...
  if (event.key == 1) { //Hvis knappen man trykker på er 1
      ...
      selected.forEach(klienttypeSelected => { //tager variablen selected og eksekverer næste linje det antal gange som der findes elementer
      ...
      window.location.href = "file:///C:/Users/ander/OneDrive%20-%20UCL%20Erhvervsakademi%20og%20Professionshøjskole/DigiKon/Projekt%202%20-%20Creditro/Drag%20and%20drop%20test/Dragn%20and%20drop/step2.html";
  }
})